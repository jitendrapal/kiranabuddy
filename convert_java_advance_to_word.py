...
print("Reading Java_Advance.md...")
with open('Java_Advance.md', 'r', encoding='utf-8') as f:
    lines = f.readlines()
...
# Save the document
print("\nSaving document as Java_Advance.docx...")
doc.save('Java_Advance.docx')

# Calculate approximate pages
total_pages = len(lines) // 40
print(f"✅ Successfully created Java_Advance.docx")
