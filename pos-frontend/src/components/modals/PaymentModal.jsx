      ...
      <div className="payment-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="payment-modal-body">
          ...
          <div className="payment-modes">
            {MODES.map((m) => (
              <button key={m} className={`payment-mode-btn${mode === m ? ' active' : ''}`}
          ...
          {mode === 'Cash' && (
            <div className="cash-section">
              ...
              <input type="number" placeholder="Enter cash amount" value={cash}
          ...
          <button className="payment-confirm-btn" onClick={handleCheckout} disabled={loading}>
