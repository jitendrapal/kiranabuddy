...
print("Reading Angular_Complete_Course.md...")
with open('Angular_Complete_Course.md', 'r', encoding='utf-8') as f:
    lines = f.readlines()
...
# Save the document
print("\nSaving document as Angular_Complete_Course.docx...")
doc.save('Angular_Complete_Course.docx')

# Calculate approximate pages
total_pages = len(lines) // 40
print(f"✅ Successfully created Angular_Complete_Course.docx")
